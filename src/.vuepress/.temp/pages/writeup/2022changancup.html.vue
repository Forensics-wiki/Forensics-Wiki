<template><div><h2 id="案件情况" tabindex="-1"><a class="header-anchor" href="#案件情况" aria-hidden="true">#</a> 案件情况</h2>
<p>某地警方接到受害人报案称其在某虚拟币交易网站遭遇诈骗，该网站号称使用“USTD 币”购买所谓的“HT 币”，受害人充 值后不但“HT 币”无法提现、交易，而且手机还被恶意软件锁定 勒索。警方根据受害人提供的虚拟币交易网站调取了对应的服 务器镜像并对案件展开侦查。</p>
<h2 id="检材地址" tabindex="-1"><a class="header-anchor" href="#检材地址" aria-hidden="true">#</a> 检材地址</h2>
<p>链接: <a href="https://pan.baidu.com/s/1JWxtyhzmjZksAos2QUaWcw?pwd=wvk4" target="_blank" rel="noopener noreferrer">https://pan.baidu.com/s/1JWxtyhzmjZksAos2QUaWcw?pwd=wvk4<ExternalLinkIcon/></a></p>
<p>提取码: wvk4</p>
<p>VeraCrypt密码：2022.4th.changancup!</p>
<p>VeraCrypt使用参考：<a href="https://www.forensics-wiki.com" target="_blank" rel="noopener noreferrer">Forensics-Wiki<ExternalLinkIcon/></a></p>
<h2 id="检材1" tabindex="-1"><a class="header-anchor" href="#检材1" aria-hidden="true">#</a> 检材1</h2>
<p>根据报案人提供的网站域名和IP，警方调取了对应的服务器镜像“检材1”，分析掌握的检材回答下列问题</p>
<h3 id="_1-检材1的sha256值为" tabindex="-1"><a class="header-anchor" href="#_1-检材1的sha256值为" aria-hidden="true">#</a> 1. 检材1的SHA256值为</h3>
<p>直接使用火眼即可得到</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221031203013152.png" alt="image-20221031203013152" tabindex="0" loading="lazy"><figcaption>image-20221031203013152</figcaption></figure>
<h3 id="_2-分析检材1-搭建该服务器的技术员ip地址是多少-用该地址解压检材2" tabindex="-1"><a class="header-anchor" href="#_2-分析检材1-搭建该服务器的技术员ip地址是多少-用该地址解压检材2" aria-hidden="true">#</a> 2. 分析检材1，搭建该服务器的技术员IP地址是多少？用该地址解压检材2</h3>
<p>可以在登录日志中查看IP都是为同一个，所以确定为技术员的IP地址即：<strong>172.16.80.100</strong></p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221031203904582.png" alt="image-20221031203904582" tabindex="0" loading="lazy"><figcaption>image-20221031203904582</figcaption></figure>
<h3 id="_3-检材1中-操作系统发行版本号为" tabindex="-1"><a class="header-anchor" href="#_3-检材1中-操作系统发行版本号为" aria-hidden="true">#</a> 3. 检材1中，操作系统发行版本号为</h3>
<p>仿真出的镜像中，使用如下命令得出：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>cat /etc/redhat-release
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221031204532795.png" alt="image-20221031204532795" tabindex="0" loading="lazy"><figcaption>image-20221031204532795</figcaption></figure>
<h3 id="_4-检材1系统中-网卡绑定的静态ip地址为" tabindex="-1"><a class="header-anchor" href="#_4-检材1系统中-网卡绑定的静态ip地址为" aria-hidden="true">#</a> 4. 检材1系统中，网卡绑定的静态IP地址为</h3>
<p>使用如下命令即可得到</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>ifconfig
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221031204920519.png" alt="image-20221031204920519" tabindex="0" loading="lazy"><figcaption>image-20221031204920519</figcaption></figure>
<h3 id="_5-检材1中-网站jar包所存放的目录是-答案为绝对路径-如-home-honglian" tabindex="-1"><a class="header-anchor" href="#_5-检材1中-网站jar包所存放的目录是-答案为绝对路径-如-home-honglian" aria-hidden="true">#</a> 5. 检材1中，网站jar包所存放的目录是(答案为绝对路径，如“/home/honglian/”)</h3>
<p>查看历史命令，发现多次进入<code v-pre>/web/app</code>目录，并执行npm等指令，进入后发现有多个jar包，确定为网站jar包所存放目录</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221031205135523.png" alt="image-20221031205135523" tabindex="0" loading="lazy"><figcaption>image-20221031205135523</figcaption></figure>
<h3 id="_6-检材1中-监听7000端口的进程对应文件名为" tabindex="-1"><a class="header-anchor" href="#_6-检材1中-监听7000端口的进程对应文件名为" aria-hidden="true">#</a> 6. 检材1中，监听7000端口的进程对应文件名为</h3>
<h4 id="方法一" tabindex="-1"><a class="header-anchor" href="#方法一" aria-hidden="true">#</a> 方法一</h4>
<p>将jar包全部导出，逐个分析，查看是哪个jar包使用了7000端口</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221031210228367.png" alt="image-20221031210228367" tabindex="0" loading="lazy"><figcaption>image-20221031210228367</figcaption></figure>
<p>在<code v-pre>cloud.jar</code>中发现使用7000端口</p>
<h4 id="方法二" tabindex="-1"><a class="header-anchor" href="#方法二" aria-hidden="true">#</a> 方法二</h4>
<p>直接启动网站，查看占用端口情况，但是较难，因为嫌疑人删除了启动脚本，在做检材2时，D盘中会有该网站的启动脚本，将检材2中的脚本复制到检材1中，启动网站即可。</p>
<h3 id="_7-检材1中-网站管理后台页面对应的网络端口为-答案填写阿拉伯数字-如-100" tabindex="-1"><a class="header-anchor" href="#_7-检材1中-网站管理后台页面对应的网络端口为-答案填写阿拉伯数字-如-100" aria-hidden="true">#</a> 7. 检材1中，网站管理后台页面对应的网络端口为（答案填写阿拉伯数字，如“100”）</h3>
<p>检材2 D盘中的start_web.sh 即启动脚本</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221031213016579.png" alt="image-20221031213016579" tabindex="0" loading="lazy"><figcaption>image-20221031213016579</figcaption></figure>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221031220959669.png" alt="image-20221031220959669" tabindex="0" loading="lazy"><figcaption>image-20221031220959669</figcaption></figure>
<p>完全启动后查看端口使用情况</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221031221301002.png" alt="image-20221031221301002" tabindex="0" loading="lazy"><figcaption>image-20221031221301002</figcaption></figure>
<p>在进入9090的时候发现为网站的后台</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221031221330898.png" alt="image-20221031221330898" tabindex="0" loading="lazy"><figcaption>image-20221031221330898</figcaption></figure>
<h3 id="_8-检材1中-网站前台页面里给出的apk的下载地址是-答案格式如下-https-www-forensix-cn-abc-def" tabindex="-1"><a class="header-anchor" href="#_8-检材1中-网站前台页面里给出的apk的下载地址是-答案格式如下-https-www-forensix-cn-abc-def" aria-hidden="true">#</a> 8. 检材1中，网站前台页面里给出的APK的下载地址是（答案格式如下：“<a href="https://www.forensix.cn/abc/def%E2%80%9D" target="_blank" rel="noopener noreferrer">https://www.forensix.cn/abc/def”<ExternalLinkIcon/></a>)</h3>
<p>依上题，查看3000端口后发现为网站前端，找到APP下载地址，扫描即可得到答案</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221031221525710.png" alt="image-20221031221525710" tabindex="0" loading="lazy"><figcaption>image-20221031221525710</figcaption></figure>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221031221709834.png" alt="image-20221031221709834" tabindex="0" loading="lazy"><figcaption>image-20221031221709834</figcaption></figure>
<h3 id="_9-检材1中-网站管理后台页面调用的用户表-admin-里的密码字段加密方式为" tabindex="-1"><a class="header-anchor" href="#_9-检材1中-网站管理后台页面调用的用户表-admin-里的密码字段加密方式为" aria-hidden="true">#</a> 9. 检材1中，网站管理后台页面调用的用户表(admin)里的密码字段加密方式为?</h3>
<h4 id="方法一-1" tabindex="-1"><a class="header-anchor" href="#方法一-1" aria-hidden="true">#</a> 方法一</h4>
<p>快进到检材3部分，找到数据库中的admin表，发现密码为32位，判断为md5</p>
<h4 id="方法二-1" tabindex="-1"><a class="header-anchor" href="#方法二-1" aria-hidden="true">#</a> 方法二</h4>
<p>反编译admin-api.jar包，在最后发现md5.key，判断为md5</p>
<h4 id="方法三" tabindex="-1"><a class="header-anchor" href="#方法三" aria-hidden="true">#</a> 方法三</h4>
<p>通过搜索md5，发现对md5的调用</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221031222612209.png" alt="image-20221031222612209" tabindex="0" loading="lazy"><figcaption>image-20221031222612209</figcaption></figure>
<h4 id="方法四" tabindex="-1"><a class="header-anchor" href="#方法四" aria-hidden="true">#</a> 方法四</h4>
<p>通过随机登录查看发送的内容</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>http://172.16.80.133:6010/admin/system/employee/googleAuth/sign/in
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221031222810213.png" alt="image-20221031222810213" tabindex="0" loading="lazy"><figcaption>image-20221031222810213</figcaption></figure>
<p>其中的<code v-pre>/sign/in</code>在admin-api.jar包中也出现了，同时后面的账号验证机制也使用到了md5key</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221031233006229.png" alt="image-20221031233006229" tabindex="0" loading="lazy"><figcaption>image-20221031233006229</figcaption></figure>
<h4 id="_10-分析检材1-网站管理后台登录密码加密算法中所使用的盐值是" tabindex="-1"><a class="header-anchor" href="#_10-分析检材1-网站管理后台登录密码加密算法中所使用的盐值是" aria-hidden="true">#</a> 10. 分析检材1，网站管理后台登录密码加密算法中所使用的盐值是</h4>
<p>在分析admin-api.jar包时，即可得到盐值</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code># system
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="检材二" tabindex="-1"><a class="header-anchor" href="#检材二" aria-hidden="true">#</a> 检材二</h2>
<p>根据IP地址落地及后续侦查，抓获了搭建网站的技术员，扣押了其个人电脑并制作镜像“检材2”，分析所有掌握的检材回答下列问题</p>
<p>由第二题答案解压得到检材二</p>
<h3 id="_11-检材2中-windows账户web-king的登录密码" tabindex="-1"><a class="header-anchor" href="#_11-检材2中-windows账户web-king的登录密码" aria-hidden="true">#</a> 11. 检材2中，windows账户Web King的登录密码</h3>
<p>通过火眼分析即可得到</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221031234044249.png" alt="image-20221031234044249" tabindex="0" loading="lazy"><figcaption>image-20221031234044249</figcaption></figure>
<h3 id="_12-检材2中-除检材1以外-还远程连接过哪个ip地址-并用该地址解压检材3" tabindex="-1"><a class="header-anchor" href="#_12-检材2中-除检材1以外-还远程连接过哪个ip地址-并用该地址解压检材3" aria-hidden="true">#</a> 12. 检材2中，除检材1以外，还远程连接过哪个IP地址？并用该地址解压检材3</h3>
<p>由第四题已知检材1的IP是：172.16.80.133</p>
<p>所以在分析结果中排除172.16.80.133，另一个IP即是答案</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221031234223097.png" alt="image-20221031234223097" tabindex="0" loading="lazy"><figcaption>image-20221031234223097</figcaption></figure>
<h3 id="_13-检材2中-powershell中输入的最后一条命令是" tabindex="-1"><a class="header-anchor" href="#_13-检材2中-powershell中输入的最后一条命令是" aria-hidden="true">#</a> 13. 检材2中，powershell中输入的最后一条命令是</h3>
<p>此处有一个误区，很多人可能以为火眼分析出的系统SSH里就是答案，但其实根据后面知道嫌疑人安装了WSL，所以该系统SSH历史输入命令其实是WSL的的历史命令。</p>
<p>而Windows中的Powershell位置是<code v-pre>%USERPROFILE%\AppData\Roaming\Microsoft\Windows\PowerShell\PSReadLine\ConsoleHost_history.txt</code></p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221031234531861.png" alt="image-20221031234531861" tabindex="0" loading="lazy"><figcaption>image-20221031234531861</figcaption></figure>
<h3 id="_14-检材2中-下载的涉案网站源代码文件名为" tabindex="-1"><a class="header-anchor" href="#_14-检材2中-下载的涉案网站源代码文件名为" aria-hidden="true">#</a> 14. 检材2中，下载的涉案网站源代码文件名为</h3>
<p>将镜像仿真起来，发现在<code v-pre>下载</code>中有多个zip</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221031235008404.png" alt="image-20221031235008404" tabindex="0" loading="lazy"><figcaption>image-20221031235008404</figcaption></figure>
<p>通过在github搜索<a href="https://github.com/sengeiou/ZTuoExchange_framework" target="_blank" rel="noopener noreferrer">ZTuoExchange_framework<ExternalLinkIcon/></a>发现符合本次比赛的案情。</p>
<h3 id="_15-检材2中-网站管理后台root账号的密码为" tabindex="-1"><a class="header-anchor" href="#_15-检材2中-网站管理后台root账号的密码为" aria-hidden="true">#</a> 15. 检材2中，网站管理后台root账号的密码为</h3>
<p>在解析出的Google浏览器中直接发现了保存的密码</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101000122797.png" alt="image-20221101000122797" tabindex="0" loading="lazy"><figcaption>image-20221101000122797</figcaption></figure>
<h3 id="_16-检材2中-技术员使用的wsl子系统发行版本是" tabindex="-1"><a class="header-anchor" href="#_16-检材2中-技术员使用的wsl子系统发行版本是" aria-hidden="true">#</a> 16. 检材2中，技术员使用的WSL子系统发行版本是</h3>
<h4 id="方法一-2" tabindex="-1"><a class="header-anchor" href="#方法一-2" aria-hidden="true">#</a> 方法一</h4>
<p>首先在开始菜单中，发现两个子系统</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101000312555.png" alt="image-20221101000312555" tabindex="0" loading="lazy"><figcaption>image-20221101000312555</figcaption></figure>
<p>但是题目要的是技术员使用的，就说明是有其他数据的</p>
<p>通过搜索得知WSL的位置是：<code v-pre>C:\Users\Web King\AppData\Local\Packages</code>，在目录下找到这两个的文件</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101000454314.png" alt="image-20221101000454314" tabindex="0" loading="lazy"><figcaption>image-20221101000454314</figcaption></figure>
<p>通过对比两个文件大小，发现20.04的版本明显大于22.04的，所以确定20.04是技术员试用的子系统</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101000636930.png" alt="image-20221101000636930" tabindex="0" loading="lazy"><figcaption>image-20221101000636930</figcaption></figure>
<h4 id="方法二-2" tabindex="-1"><a class="header-anchor" href="#方法二-2" aria-hidden="true">#</a> 方法二</h4>
<p>通过在仿真的镜像中启动子系统，发现20.04是可以直接进入命令行的，而22.04是需要进行配置的</p>
<h4 id="方法三-1" tabindex="-1"><a class="header-anchor" href="#方法三-1" aria-hidden="true">#</a> 方法三</h4>
<p>使用指令得到</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>wsl -l -v
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101001052352.png" alt="image-20221101001052352" tabindex="0" loading="lazy"><figcaption>image-20221101001052352</figcaption></figure>
<h3 id="_17-检材2中-运行的数据库服务版本号是" tabindex="-1"><a class="header-anchor" href="#_17-检材2中-运行的数据库服务版本号是" aria-hidden="true">#</a> 17. 检材2中，运行的数据库服务版本号是</h3>
<p>在启动mysql后，使用命令直接得到</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101002019150.png" alt="image-20221101002019150" tabindex="0" loading="lazy"><figcaption>image-20221101002019150</figcaption></figure>
<h3 id="_18-上述数据库debian-sys-maint用户的初始密码是" tabindex="-1"><a class="header-anchor" href="#_18-上述数据库debian-sys-maint用户的初始密码是" aria-hidden="true">#</a> 18. 上述数据库debian-sys-maint用户的初始密码是</h3>
<p>通过搜索得知debian-sys-maint用户的初始密码位于/etc/mysql/debian.cnf中</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101002205932.png" alt="image-20221101002205932" tabindex="0" loading="lazy"><figcaption>image-20221101002205932</figcaption></figure>
<h3 id="_19-检材3服务器root账号的密码是" tabindex="-1"><a class="header-anchor" href="#_19-检材3服务器root账号的密码是" aria-hidden="true">#</a> 19. 检材3服务器root账号的密码是</h3>
<p>在检材2的系统SSH历史输入命令中，发现曾使用sshpass对172.16.80.128进行连接，连接密码为<code v-pre>h123456</code></p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101002342400.png" alt="image-20221101002342400" tabindex="0" loading="lazy"><figcaption>image-20221101002342400</figcaption></figure>
<h2 id="检材三" tabindex="-1"><a class="header-anchor" href="#检材三" aria-hidden="true">#</a> 检材三</h2>
<p>根据网站前端和技术员个人电脑上的线索，发现了网站后端所在的服务器IP并再次调证取得“检材3”，分析所有掌握的检材回答下列问题</p>
<p>通过第12题答案，解压检材3</p>
<h3 id="_20-检材3中-监听33050端口的程序名-program-name-为" tabindex="-1"><a class="header-anchor" href="#_20-检材3中-监听33050端口的程序名-program-name-为" aria-hidden="true">#</a> 20. 检材3中，监听33050端口的程序名（program name)为</h3>
<p>在历史命令中发现嫌疑人进入了/data/mysql 之后使用了docker-compose up</p>
<p>进入目录后，查看docker-compose.yml配置文件，发现使用了33050，尝试启动后发现program name</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101120302903.png" alt="image-20221101120302903" tabindex="0" loading="lazy"><figcaption>image-20221101120302903</figcaption></figure>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101120543991.png" alt="image-20221101120543991" tabindex="0" loading="lazy"><figcaption>image-20221101120543991</figcaption></figure>
<h3 id="_21-除mysql外-该网站还依赖以下哪种数据库" tabindex="-1"><a class="header-anchor" href="#_21-除mysql外-该网站还依赖以下哪种数据库" aria-hidden="true">#</a> 21. 除MySQL外，该网站还依赖以下哪种数据库</h3>
<p>在分析检材一时，对于admin-api.jar的分析中，发现他使用了redis以及mongo</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101120831194.png" alt="image-20221101120831194" tabindex="0" loading="lazy"><figcaption>image-20221101120831194</figcaption></figure>
<h3 id="_22-检材3中-mysql数据库root账号的密码是" tabindex="-1"><a class="header-anchor" href="#_22-检材3中-mysql数据库root账号的密码是" aria-hidden="true">#</a> 22.  检材3中，MySQL数据库root账号的密码是</h3>
<h4 id="方法一-3" tabindex="-1"><a class="header-anchor" href="#方法一-3" aria-hidden="true">#</a> 方法一</h4>
<p>同样在admin-api.jar中也可分析出密码</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101121005822.png" alt="image-20221101121005822" tabindex="0" loading="lazy"><figcaption>image-20221101121005822</figcaption></figure>
<h4 id="方法二-3" tabindex="-1"><a class="header-anchor" href="#方法二-3" aria-hidden="true">#</a> 方法二</h4>
<p>在docker-compose配置文件中也能找到</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101121231075.png" alt="image-20221101121231075" tabindex="0" loading="lazy"><figcaption>image-20221101121231075</figcaption></figure>
<h3 id="_23-检材3中-mysql数据库在容器内部的数据目录为" tabindex="-1"><a class="header-anchor" href="#_23-检材3中-mysql数据库在容器内部的数据目录为" aria-hidden="true">#</a> 23. 检材3中，MySQL数据库在容器内部的数据目录为</h3>
<h4 id="方法一-4" tabindex="-1"><a class="header-anchor" href="#方法一-4" aria-hidden="true">#</a> 方法一</h4>
<p>通过对docker-compose.yml的分析，可以看到它是将<code v-pre>/data/mysql/db</code>目录，挂载到了容器的<code v-pre>/var/lib/mysql</code>中，所以<code v-pre>/var/lib/mysql</code>就是他的数据目录</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101121352048.png" alt="image-20221101121352048" tabindex="0" loading="lazy"><figcaption>image-20221101121352048</figcaption></figure>
<h4 id="方法二-4" tabindex="-1"><a class="header-anchor" href="#方法二-4" aria-hidden="true">#</a> 方法二</h4>
<p>通过进入容器内部找到相关信息</p>
<div class="language-docker line-numbers-mode" data-ext="docker"><pre v-pre class="language-docker"><code>docker exec -it 8eda4cb0b452 bash
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101121705555.png" alt="image-20221101121705555" tabindex="0" loading="lazy"><figcaption>image-20221101121705555</figcaption></figure>
<h3 id="_24-涉案网站调用的mysql数据库名为" tabindex="-1"><a class="header-anchor" href="#_24-涉案网站调用的mysql数据库名为" aria-hidden="true">#</a> 24. 涉案网站调用的MySQL数据库名为</h3>
<p>通过对于admin-api.jar包的分析，发现他连接的数据库名是b1</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101121918839.png" alt="image-20221101121918839" tabindex="0" loading="lazy"><figcaption>image-20221101121918839</figcaption></figure>
<h3 id="_25-勒索者在数据库中修改了多少个用户的手机号" tabindex="-1"><a class="header-anchor" href="#_25-勒索者在数据库中修改了多少个用户的手机号" aria-hidden="true">#</a> 25. 勒索者在数据库中修改了多少个用户的手机号？</h3>
<p>首先在<code v-pre>/data/mysql/db</code>发现了<code v-pre>8eda4cb0b452.log</code>该文件。发现里面记录了创建表等日志</p>
<p>通过搜索<code v-pre>UPDATE</code>发现他修改了<code v-pre>b1</code>数据库的<code v-pre>member表</code>中的<code v-pre>mobile_phone</code>,计数找到<code v-pre>8次</code>分别是</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>2022-10-18T08:48:06.120268Z	    8 Query	update admin set last_login_time='2022-10-18 04:48:06.114', last_login_ip=null where id=1
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>但是发现这8次中，有5次都是关于登录信息的，所以排除，因此只有<code v-pre>3个</code></p>
<h3 id="_26-勒索者在数据库中删除的用户数量为" tabindex="-1"><a class="header-anchor" href="#_26-勒索者在数据库中删除的用户数量为" aria-hidden="true">#</a> 26.  勒索者在数据库中删除的用户数量为</h3>
<p>在该日志中搜索<code v-pre>DELETE</code>发现他删除了<code v-pre>b1</code>数据库的<code v-pre>member表</code>的内容，从973一直删到了1000，所以删除了28个用户</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101123732257.png" alt="image-20221101123732257" tabindex="0" loading="lazy"><figcaption>image-20221101123732257</figcaption></figure>
<h3 id="_27-还原被破坏的数据库-分析除技术员以外-还有哪个ip地址登录过管理后台网站-用该地址解压-检材4" tabindex="-1"><a class="header-anchor" href="#_27-还原被破坏的数据库-分析除技术员以外-还有哪个ip地址登录过管理后台网站-用该地址解压-检材4" aria-hidden="true">#</a> 27. 还原被破坏的数据库，分析除技术员以外，还有哪个IP地址登录过管理后台网站？用该地址解压 检材4</h3>
<h4 id="方法一-直接恢复数据库连接分析" tabindex="-1"><a class="header-anchor" href="#方法一-直接恢复数据库连接分析" aria-hidden="true">#</a> 方法一 直接恢复数据库连接分析</h4>
<p>首先还原被破坏的数据库，b1数据库在检材三中被删除了，因为需要将检材二中的b1放进去，然后启动mysql</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101124621763.png" alt="image-20221101124621763" tabindex="0" loading="lazy"><figcaption>image-20221101124621763</figcaption></figure>
<p>之后连接数据库，在admin表中发现了登录的历史IP</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101125006270.png" alt="image-20221101125006270" tabindex="0" loading="lazy"><figcaption>image-20221101125006270</figcaption></figure>
<h4 id="方法二-使用火眼数据库分析工具分析b1数据库" tabindex="-1"><a class="header-anchor" href="#方法二-使用火眼数据库分析工具分析b1数据库" aria-hidden="true">#</a> 方法二 使用火眼数据库分析工具分析b1数据库</h4>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101125100662.png" alt="image-20221101125100662" tabindex="0" loading="lazy"><figcaption>image-20221101125100662</figcaption></figure>
<h3 id="_28-还原全部被删改数据-用户id为500的注册会员的ht币钱包地址为" tabindex="-1"><a class="header-anchor" href="#_28-还原全部被删改数据-用户id为500的注册会员的ht币钱包地址为" aria-hidden="true">#</a> 28. 还原全部被删改数据，用户id为500的注册会员的HT币钱包地址为</h3>
<p>在<code v-pre>member_wallet表</code>中，找到ID=500的用户，直接可以得到</p>
<blockquote>
<p>cee631121c2ec9232f3a2f028ad5c89b</p>
</blockquote>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101130236339.png" alt="image-20221101130236339" tabindex="0" loading="lazy"><figcaption>image-20221101130236339</figcaption></figure>
<h3 id="_29-还原全部被删改数据-共有多少名用户的会员等级为-lv3" tabindex="-1"><a class="header-anchor" href="#_29-还原全部被删改数据-共有多少名用户的会员等级为-lv3" aria-hidden="true">#</a> 29. 还原全部被删改数据，共有多少名用户的会员等级为'LV3'</h3>
<p><code v-pre>member</code>表中会找到答案，member_grade_id`为3的情况下数据库中有158个</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101131643580.png" alt="image-20221101131643580" tabindex="0" loading="lazy"><figcaption>image-20221101131643580</figcaption></figure>
<p>然而并未考虑被删除的用户中LV=3的用户数量</p>
<p>被删除的用户如下：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>2022-10-19T03:16:36.987428Z	   13 Query	DELETE FROM `b1`.`member` WHERE `id` = 973
...
<div class="language-MYSQL line-numbers-mode" data-ext="MYSQL"><pre v-pre class="language-MYSQL"><code>2022-10-19T03:12:07.961675Z	   12 Query	INSERT INTO `member` VALUES (973, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, NULL, '中国', NULL, NULL, 0, 0, NULL, 0, '13532680973', 'ee455f8f8e5d321861ed7ef5bde6dbc5', 'U000001Lo973', 1, NULL, 0, '2022-10-18 13:4:24', '353233323433333238363833323439363634', 0, b'1', 0, 0, 'c3d54ed7-b20f-430b-8f9a-b517c1973', '2022-10-18 13:4:24', 1, NULL, 0, '13532680973', NULL, NULL, '中国', 0, 3, 0, 0, NULL)
...
<p>再把这6个人加上，所以一共是158+6=164人</p>
<h3 id="_30-还原全部被删改数据-哪些用户id没有充值记录" tabindex="-1"><a class="header-anchor" href="#_30-还原全部被删改数据-哪些用户id没有充值记录" aria-hidden="true">#</a> 30.  还原全部被删改数据，哪些用户ID没有充值记录</h3>
<p>在<code v-pre>membet_transaction</code>中找到充值记录</p>
<p>然后使用查询语句，发现有2个人没有充值(当然也可以用Excel删除重复值)</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT member_id , COUNT(id),SUM(amount) FROM member_transaction GROUP BY member_id
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101132128845.png" alt="image-20221101132128845" tabindex="0" loading="lazy"><figcaption>image-20221101132128845</figcaption></figure>
<h4 id="方法一-5" tabindex="-1"><a class="header-anchor" href="#方法一-5" aria-hidden="true">#</a> 方法一</h4>
<p>导入Excel中，看从哪里开始，Excel的行数和数值不一样了。</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101132333636.png" alt="image-20221101132333636" tabindex="0" loading="lazy"><figcaption>image-20221101132333636</figcaption></figure>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101132443286.png" alt="image-20221101132443286" tabindex="0" loading="lazy"><figcaption>image-20221101132443286</figcaption></figure>
<h4 id="方法二-5" tabindex="-1"><a class="header-anchor" href="#方法二-5" aria-hidden="true">#</a> 方法二</h4>
<p><code v-pre>member_wallet</code>中的<code v-pre>balance</code>就是他的充值记录，找到为0的就是没有充值的。</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101132735075.png" alt="image-20221101132735075" tabindex="0" loading="lazy"><figcaption>image-20221101132735075</figcaption></figure>
<h3 id="_31-还原全部被删改数据-2022年10月17日总计产生多少笔交易记录" tabindex="-1"><a class="header-anchor" href="#_31-还原全部被删改数据-2022年10月17日总计产生多少笔交易记录" aria-hidden="true">#</a> 31. 还原全部被删改数据，2022年10月17日总计产生多少笔交易记录？</h3>
<p>直接使用语句查询</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT * FROM `member_transaction` WHERE create_time BETWEEN &quot;2022-10-17  00:00:00&quot; AND &quot;2022-10-17 23:59:59&quot;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101133059205.png" alt="image-20221101133059205" tabindex="0" loading="lazy"><figcaption>image-20221101133059205</figcaption></figure>
<h3 id="_32-还原全部被删改数据-该网站中充值的usdt总额为" tabindex="-1"><a class="header-anchor" href="#_32-还原全部被删改数据-该网站中充值的usdt总额为" aria-hidden="true">#</a> 32. 还原全部被删改数据，该网站中充值的USDT总额为</h3>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT SUM(amount) FROM member_transaction
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101133542896.png" alt="image-20221101133542896" tabindex="0" loading="lazy"><figcaption>image-20221101133542896</figcaption></figure>
<h2 id="检材四" tabindex="-1"><a class="header-anchor" href="#检材四" aria-hidden="true">#</a> 检材四</h2>
<p>根据前期侦查分析，通过技术手段找到了幕后老板，并对其使用的安卓模拟器“检材4”进行了固定。分析所有掌握的检材，回答下列问题</p>
<p>修改文件为zip，然后打开发现vmdk文件，导入火眼中分析</p>
<h3 id="_33-嫌疑人使用的安卓模拟器软件名称是" tabindex="-1"><a class="header-anchor" href="#_33-嫌疑人使用的安卓模拟器软件名称是" aria-hidden="true">#</a> 33. 嫌疑人使用的安卓模拟器软件名称是</h3>
<p>搜索npbk文件，发现是夜神模拟器</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101135221865.png" alt="image-20221101135221865" tabindex="0" loading="lazy"><figcaption>image-20221101135221865</figcaption></figure>
<h3 id="_34-检材4中-老板-的阿里云账号是" tabindex="-1"><a class="header-anchor" href="#_34-检材4中-老板-的阿里云账号是" aria-hidden="true">#</a> 34. 检材4中，“老板”的阿里云账号是</h3>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101135452879.png" alt="image-20221101135452879" tabindex="0" loading="lazy"><figcaption>image-20221101135452879</figcaption></figure>
<h3 id="_35-检材4中安装的vpn工具的软件名称是" tabindex="-1"><a class="header-anchor" href="#_35-检材4中安装的vpn工具的软件名称是" aria-hidden="true">#</a> 35.检材4中安装的VPN工具的软件名称是</h3>
<p>使用火眼直接分析得到</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101135257781.png" alt="image-20221101135257781" tabindex="0" loading="lazy"><figcaption>image-20221101135257781</figcaption></figure>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101135908455.png" alt="image-20221101135908455" tabindex="0" loading="lazy"><figcaption>image-20221101135908455</figcaption></figure>
<h3 id="_36-上述vpn工具中记录的节点ip是" tabindex="-1"><a class="header-anchor" href="#_36-上述vpn工具中记录的节点ip是" aria-hidden="true">#</a> 36. 上述VPN工具中记录的节点IP是</h3>
<h4 id="方法一-6" tabindex="-1"><a class="header-anchor" href="#方法一-6" aria-hidden="true">#</a> 方法一</h4>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101135531549.png" alt="image-20221101135531549" tabindex="0" loading="lazy"><figcaption>image-20221101135531549</figcaption></figure>
<h4 id="方法二-6" tabindex="-1"><a class="header-anchor" href="#方法二-6" aria-hidden="true">#</a> 方法二</h4>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101135853446.png" alt="image-20221101135853446" tabindex="0" loading="lazy"><figcaption>image-20221101135853446</figcaption></figure>
<h3 id="_37-检材4中-录屏软件安装时间为" tabindex="-1"><a class="header-anchor" href="#_37-检材4中-录屏软件安装时间为" aria-hidden="true">#</a> 37. 检材4中，录屏软件安装时间为</h3>
<p>通过apk的位置找到软件的包名</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101140649170.png" alt="image-20221101140649170" tabindex="0" loading="lazy"><figcaption>image-20221101140649170</figcaption></figure>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101140437417.png" alt="image-20221101140437417" tabindex="0" loading="lazy"><figcaption>image-20221101140437417</figcaption></figure>
<blockquote>
<p>2022-10-19 10:50:27</p>
</blockquote>
<h3 id="_38-上述录屏软件中名为-s-20221019105129-的录像-在模拟器存储中对应的原始文件名为" tabindex="-1"><a class="header-anchor" href="#_38-上述录屏软件中名为-s-20221019105129-的录像-在模拟器存储中对应的原始文件名为" aria-hidden="true">#</a> 38. 上述录屏软件中名为“s_20221019105129”的录像，在模拟器存储中对应的原始文件名为</h3>
<p>在<code v-pre>Nox_2-disk2.vmdk/分区4/data/com.jiadi.luping/databases/record.db</code>中分析该数据库，发现保存有文件的相关信息</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101141104263.png" alt="image-20221101141104263" tabindex="0" loading="lazy"><figcaption>image-20221101141104263</figcaption></figure>
<blockquote>
<p>0c2f5dd4a9bc6f34873fb3c0ee9b762b98e8c46626410be7191b11710117a12d</p>
</blockquote>
<h3 id="_39-上述录屏软件登录的手机号是" tabindex="-1"><a class="header-anchor" href="#_39-上述录屏软件登录的手机号是" aria-hidden="true">#</a> 39. 上述录屏软件登录的手机号是</h3>
<p>通过导出record.db还有record.db-wal文件，导入DB Brower中分析得到</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101142013326.png" alt="image-20221101142013326" tabindex="0" loading="lazy"><figcaption>image-20221101142013326</figcaption></figure>
<blockquote>
<p>18645091802</p>
</blockquote>
<h3 id="_40-检材4中-发送勒索邮件的邮箱地址为" tabindex="-1"><a class="header-anchor" href="#_40-检材4中-发送勒索邮件的邮箱地址为" aria-hidden="true">#</a> 40. 检材4中，发送勒索邮件的邮箱地址为</h3>
<p>火眼直接分析得到</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101142058008.png" alt="image-20221101142058008" tabindex="0" loading="lazy"><figcaption>image-20221101142058008</figcaption></figure>
<blockquote>
<p><a href="mailto:skterran@163.com">skterran@163.com</a></p>
</blockquote>
<h2 id="exe分析" tabindex="-1"><a class="header-anchor" href="#exe分析" aria-hidden="true">#</a> EXE分析</h2>
<p>分析所有掌握的检材，找到勒索邮件中被加密的文档和对应的加/解密程序，并回答下列问题</p>
<h3 id="_41-分析加密程序-编译该加密程序使用的语言是" tabindex="-1"><a class="header-anchor" href="#_41-分析加密程序-编译该加密程序使用的语言是" aria-hidden="true">#</a> 41.分析加密程序，编译该加密程序使用的语言是</h3>
<h4 id="方法一-7" tabindex="-1"><a class="header-anchor" href="#方法一-7" aria-hidden="true">#</a> 方法一</h4>
<p>使用Detect It Easy可以直接分析出</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101143618187.png" alt="image-20221101143618187" tabindex="0" loading="lazy"><figcaption>image-20221101143618187</figcaption></figure>
<h4 id="方法二-7" tabindex="-1"><a class="header-anchor" href="#方法二-7" aria-hidden="true">#</a> 方法二</h4>
<p>IDA分析得到为python</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101144111978.png" alt="image-20221101144111978" tabindex="0" loading="lazy"><figcaption>image-20221101144111978</figcaption></figure>
<h3 id="_42-分析加密程序-它会加密哪些扩展名的文件" tabindex="-1"><a class="header-anchor" href="#_42-分析加密程序-它会加密哪些扩展名的文件" aria-hidden="true">#</a> 42. 分析加密程序，它会加密哪些扩展名的文件？</h3>
<p>参考文章：<a href="https://www.jianshu.com/p/9f35a6f7ba05" target="_blank" rel="noopener noreferrer">https://www.jianshu.com/p/9f35a6f7ba05<ExternalLinkIcon/></a></p>
<p>依据参考文章，下载相关逆向工具</p>
<p>注意：如果参考文章中的下载后的文件执行命令后没有pyc后缀，请使用<a href="https://github.com/extremecoders-re/pyinstxtractor" target="_blank" rel="noopener noreferrer">Github的版本<ExternalLinkIcon/></a>，可以直接生成pyc文件</p>
<p>执行如下命令生成目录</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>python pyinstxtractor<span class="token punctuation">.</span>py encrypt_file<span class="token punctuation">.</span>exe
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101152213649.png" alt="image-20221101152213649" tabindex="0" loading="lazy"><figcaption>image-20221101152213649</figcaption></figure>
<p>之后安装uncompyle6</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>pip3 install uncompyle6
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>安装好后，开始反编译</p>
<div class="language-powershell line-numbers-mode" data-ext="powershell"><pre v-pre class="language-powershell"><code><span class="token function">PS</span> E:\1762326648\Deskop\新建文件夹> uncompyle6<span class="token punctuation">.</span>exe E:\1762326648\Deskop\新建文件夹\encrypt_file<span class="token punctuation">.</span>exe_extracted\encrypt_file_1<span class="token punctuation">.</span>pyc
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过剖析代码，发现加密文件的类型</p>
<div class="language-powershell line-numbers-mode" data-ext="powershell"><pre v-pre class="language-powershell"><code> <span class="token keyword">if</span> <span class="token string">'.txt'</span> == ExtensionPath or <span class="token string">'.jpg'</span> == ExtensionPath or <span class="token string">'.xls'</span> == ExtensionPath or <span class="token string">'.docx'</span> == ExtensionPath:
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_43-分析加密程序-是通过什么算法对文件进行加密的" tabindex="-1"><a class="header-anchor" href="#_43-分析加密程序-是通过什么算法对文件进行加密的" aria-hidden="true">#</a> 43. 分析加密程序，是通过什么算法对文件进行加密的？</h3>
<p>剖析代码</p>
<div class="language-powershell line-numbers-mode" data-ext="powershell"><pre v-pre class="language-powershell"><code>data_file = os<span class="token punctuation">.</span>path<span class="token punctuation">.</span>join<span class="token punctuation">(</span>filepath<span class="token punctuation">,</span> filename<span class="token punctuation">)</span>
                    rsakey = RSA<span class="token punctuation">.</span>import_key<span class="token punctuation">(</span>pubkey<span class="token punctuation">)</span>
                    cipher = Cipher_pkcs1_v1_5<span class="token punctuation">.</span>new<span class="token punctuation">(</span>rsakey<span class="token punctuation">)</span>
                    xor_key = os<span class="token punctuation">.</span>urandom<span class="token punctuation">(</span>16<span class="token punctuation">)</span>
                    xor_obj = XORCBC<span class="token punctuation">(</span>xor_key<span class="token punctuation">)</span>
                    ...
                    outf<span class="token punctuation">.</span>close<span class="token punctuation">(</span><span class="token punctuation">)</span>
                    os<span class="token punctuation">.</span>remove<span class="token punctuation">(</span>data_file<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>首先把<code v-pre>公钥</code>导入，生成一个<code v-pre>rsakey</code>，然后把<code v-pre>rsakey</code>通过<code v-pre>cipher</code>加密生成了一个<code v-pre>cipher字符串</code>随后通过<code v-pre>cipher</code>加密了<code v-pre>xor_key</code>，<code v-pre>xor_key</code>是一个随机的16位字符串（os.urandom(16)），因此是<code v-pre>outf.write(encrypted_xor_key)</code>加密了文件，因此加密过程实际如下：</p>
<div class="language-powershell line-numbers-mode" data-ext="powershell"><pre v-pre class="language-powershell"><code><span class="token keyword">class</span> XORCBC:
...
<h3 id="_44-分析加密程序-其使用的非对称加密方式公钥后5位为" tabindex="-1"><a class="header-anchor" href="#_44-分析加密程序-其使用的非对称加密方式公钥后5位为" aria-hidden="true">#</a> 44. 分析加密程序，其使用的非对称加密方式公钥后5位为？</h3>
<p>根据解密后的内容得到公钥</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>pubkey = '-----BEGIN PUBLIC KEY-----\\n-----END PUBLIC KEY-----\n'
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>可以直接得到<code v-pre>u+w==</code></p>
<h3 id="_45-被加密文档中-flag1的值是" tabindex="-1"><a class="header-anchor" href="#_45-被加密文档中-flag1的值是" aria-hidden="true">#</a> 45. 被加密文档中，FLAG1的值是</h3>
<p>通过相同的方法，对decrypt_file.exe进行逆向</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101153641606.png" alt="image-20221101153641606" tabindex="0" loading="lazy"><figcaption>image-20221101153641606</figcaption></figure>
<div class="language-powershell line-numbers-mode" data-ext="powershell"><pre v-pre class="language-powershell"><code><span class="token function">PS</span> E:\1762326648\Deskop\长安杯\文件文档_20221101_142818\火眼<span class="token operator">-</span>文件导出> uncompyle6<span class="token punctuation">.</span>exe E:\1762326648\Deskop\长安杯\文件文档_20221101_142818\火眼<span class="token operator">-</span>文件导出\decrypt_file<span class="token punctuation">.</span>exe_extracted\decrypt_file_1<span class="token punctuation">.</span>pyc
<span class="token comment"># uncompyle6 version 3.8.0</span>
<span class="token comment"># Python bytecode 3.6 (3379)</span>
<span class="token comment"># Decompiled from: Python 3.10.1 (tags/v3.10.1:2cd268a, Dec  6 2021, 19:10:37) [MSC v.1929 64 bit (AMD64)]</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>随后得到的密码为：<code v-pre>4008003721</code></p>
<p>使用该密码解密</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101153933213.png" alt="image-20221101153933213" tabindex="0" loading="lazy"><figcaption>image-20221101153933213</figcaption></figure>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101153949542.png" alt="image-20221101153949542" tabindex="0" loading="lazy"><figcaption>image-20221101153949542</figcaption></figure>
<blockquote>
<p>FLAG1:TREFWGFS</p>
</blockquote>
<h2 id="apk分析-包子-写的" tabindex="-1"><a class="header-anchor" href="#apk分析-包子-写的" aria-hidden="true">#</a> APK分析（“包子”写的）</h2>
<h3 id="_46-恶意apk程序的包名为" tabindex="-1"><a class="header-anchor" href="#_46-恶意apk程序的包名为" aria-hidden="true">#</a> 46. 恶意APK程序的包名为</h3>
<p>雷电直接获取到包名</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101210423239.png" alt="image-20221101210423239" tabindex="0" loading="lazy"><figcaption>image-20221101210423239</figcaption></figure>
<h3 id="_47-apk调用的权限包括" tabindex="-1"><a class="header-anchor" href="#_47-apk调用的权限包括" aria-hidden="true">#</a> 47. APK调用的权限包括</h3>
<p>在静态权限中直接获取，也可在<code v-pre>AndroidManifest.xml</code>中得到</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101210731955.png" alt="image-20221101210731955" tabindex="0" loading="lazy"><figcaption>image-20221101210731955</figcaption></figure>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101210741809.png" alt="image-20221101210741809" tabindex="0" loading="lazy"><figcaption>image-20221101210741809</figcaption></figure>
<h3 id="_48-解锁第一关所使用的flag2值为" tabindex="-1"><a class="header-anchor" href="#_48-解锁第一关所使用的flag2值为" aria-hidden="true">#</a> 48. 解锁第一关所使用的FLAG2值为</h3>
<p>首先对APK进行脱壳处理。</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/3.png" alt="3" tabindex="0" loading="lazy"><figcaption>3</figcaption></figure>
<p>反编译后之后搜索FLAG，得到FLAG2</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101215745940.png" alt="image-20221101215745940" tabindex="0" loading="lazy"><figcaption>image-20221101215745940</figcaption></figure>
<h3 id="_49-解锁第二关所使用的flag3值为-flag为8位字符串-如需在apk中输入flag-请输入完整内容-如输入-flag9-qwert123" tabindex="-1"><a class="header-anchor" href="#_49-解锁第二关所使用的flag3值为-flag为8位字符串-如需在apk中输入flag-请输入完整内容-如输入-flag9-qwert123" aria-hidden="true">#</a> 49.解锁第二关所使用的FLAG3值为(FLAG为8位字符串，如需在apk中输入FLAG，请输入完整内容，如输入&quot;FLAG9:QWERT123&quot;)</h3>
<p>剖析apk发现</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>((i2 &amp; 1) != 0)</code>对应了<code v-pre>FLAG2</code></p>
<p>不等于0时对应了FLAG3，所以FLAG3对应了如下内容</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>解析代码发现是把输入的值转为字符串之后，使用equals函数和前面的作比较，比较正确后返回<code v-pre>true</code>，所以<code v-pre>OooO0oo</code>应当是他所要对比的值，搜索在哪里对这个值进行了定义</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101230159603.png" alt="image-20221101230159603" tabindex="0" loading="lazy"><figcaption>image-20221101230159603</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>分析得到对<code v-pre>ffd4d7459ad24cd035611b014a2cccac</code>进行了两层加密，查找<code v-pre>OooO0O0</code>的用例</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">byte</span><span class="token punctuation">[</span><span class="token punctuation">]</span> <span class="token class-name">OooO0O0</span><span class="token punctuation">(</span><span class="token class-name">String</span> str<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>首先<code v-pre>ffd4d7459ad24cd035611b014a2cccac</code>是一个十六进制，将其转为数组，然后使用<code v-pre>decrypt</code>函数进行加密</p>
<p>分析<code v-pre>decrypt</code>函数</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>init</code>函数调用了<code v-pre>libcipher.so</code>对密文进行了解密，与输入的值进行比较，最终判断是否正确</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/image-20221101230636170.png" alt="image-20221101230636170" tabindex="0" loading="lazy"><figcaption>image-20221101230636170</figcaption></figure>
<p>所以将他执行的函数调用出来，执行一下，就可得到<code v-pre>OooO0O0</code>的输出，直接调用一个安卓的工程，把代码执行下来</p>
<p>APP.java如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>example<span class="token punctuation">.</span>hanshu</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>最后连接模拟器，将此apk推送到模拟器中，查看日志，即可找到FLAG3</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/24.png" alt="24" tabindex="0" loading="lazy"><figcaption>24</figcaption></figure>
<h3 id="_50-解锁第三关所需的key值由ascii可显示字符组成-请请分析获取该key值" tabindex="-1"><a class="header-anchor" href="#_50-解锁第三关所需的key值由ascii可显示字符组成-请请分析获取该key值" aria-hidden="true">#</a> 50.解锁第三关所需的KEY值由ASCII可显示字符组成，请请分析获取该KEY值</h3>
<p>进入第三关，要输入Key值，查看代码</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/17.png" alt="17" tabindex="0" loading="lazy"><figcaption>17</figcaption></figure>
<p>找到(i2 &amp; 4) == 0的地方</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/18.png" alt="18" tabindex="0" loading="lazy"><figcaption>18</figcaption></figure>
<p>也是做了输入字符串的判断<br>
跳转到声明处，可以看到一系列比较复杂的算法</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/19.png" alt="19" tabindex="0" loading="lazy"><figcaption>19</figcaption></figure>
<p>思路是用键盘可输入的字符串制作字典，进行暴力破解<br>
再次使用Android Studio，编写代码，遍历六组数，通过算法，for循环，跑字典，算值，跑出有哪些字符可对应相应数组</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/20.png" alt="20" tabindex="0" loading="lazy"><figcaption>20</figcaption></figure>
<p>得到结果，按照六祖数的顺序，进行排序即可得到最终的key</p>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/21.png" alt="21" tabindex="0" loading="lazy"><figcaption>21</figcaption></figure>
<figure><img src="https://didctf-blog-post.oss-cn-beijing.aliyuncs.com/post/22.png" alt="22" tabindex="0" loading="lazy"><figcaption>22</figcaption></figure>
</div></template>
