...
import { ComponentController, defineElement, Component, prop, defineProp, method } from 'maverick.js/element';
import { s as scopedRaf, A as ARIAKeyShortcuts, a as setAttributeIfEmpty, o as onPress, u as useMedia, b as setARIALabel, i as isTrackCaptionKind, f as functionThrottle, c as findActiveCue, d as onTrackChapterChange, e as isElementParent, g as isCueActive, p as preconnect } from './media-core.js';
import { $$_create_component, $$_ssr, $$_classes, $$_attr, $$_custom_element } from 'maverick.js/ssr';
import { I as Icon } from './icons/icon.js';
import { setAttribute, ariaBool as ariaBool$1, listenEvent, isNull, isNumber, setStyle, isDOMEvent, isKeyboardEvent, isUndefined, animationFrameThrottle, isDOMElement, isPointerEvent, isMouseEvent, isTouchEvent, kebabToCamelCase, createDisposalBin } from 'maverick.js/std';
...
const $$_templ$i = ['<!$><div part="track"', "></div>"], $$_templ_2$7 = ['<!$><div part="track track-fill"', "></div>"], $$_templ_3$2 = ['<!$><div part="track track-progress"', "></div>"], $$_templ_4 = ['<!$><div part="thumb-container"', '><!$><div part="thumb"', "></div></div>"];
class Slider extends Component {
  ...
  render() {
    ...
    return [
      $$_ssr($$_templ$i, $$_classes(trackClass)),
      $$_ssr($$_templ_2$7, $$_classes(trackFillClass)),
      $$_ssr($$_templ_3$2, $$_classes(trackProgressClass)),
...
const $$_templ$h = ["<!$><img", "", ' part="img" loading="eager" decoding="async" aria-hidden="true" />'];
class Thumbnail extends Component {
  ...
  render() {
    ...
    return $$_ssr($$_templ$h, $$_attr("src", this._src), $$_attr("crossorigin", crossorigin));
  }
}
...
const $$_templ$g = ["<!$><media-thumbnail", "", "</media-thumbnail>"];
class SliderThumbnail extends Component {
  ...
  render() {
    ...
    return $$_ssr($$_templ$g, ...$$_custom_element("media-thumbnail", void 0, [{ "part": "thumbnail", "time": time }]));
  }
}
...
const $$_templ$f = ['<!$><video muted="" playsinline="" preload="auto"', "", ' part="video" style="max-width: unset"></video>'];
class SliderVideo extends Component {
  ...
  render() {
    const { crossorigin } = this._media.$store;
    return $$_ssr($$_templ$f, $$_attr("src", this._src), $$_attr("crossorigin", crossorigin));
  }
  _getSrc() {
...
class SliderValue extends Component {
  ...
  render() {
    return $$_ssr($$_templ$e, this._text);
  }
}
...
const $$_templ$d = ['<!$><div part="chapters"', "><!$>", "</div>"], $$_templ_2$6 = [""], $$_templ_3$1 = ['<!$><div part="chapter-container"><div part="chapter"><div part="track"></div><div part="track track-fill" style="width: 0%"></div><div part="track track-progress" style="width: 0%"></div></div></div>'];
class SliderChaptersRenderer {
  ...
  render(cues, $class) {
    return $$_ssr(
      $$_templ_2$6,
      cues?.length ? $$_ssr($$_templ$d, $$_classes($class), this._renderChapters(cues)) : null
    );
  }
...
const $$_templ$c = [""], $$_templ_2$5 = $$_templ$c;
class TimeSlider extends Slider {
  ...
  render() {
    ...
    return [$$_ssr($$_templ$c, this._chaptersRenderer.render(this._track()?.cues, chaptersClass)), $$_ssr($$_templ_2$5, tracks)];
  }
...
const $$_templ$b = ['<!$><div part="check"></div>'];
...
const $$_templ$a = ["<!$><media-radio-group", "", "<!$>", "</media-radio-group>"], $$_templ_2$4 = ["<!$><media-radio", "", "<!$>", "</media-radio>"];
function renderRadioGroup(props) {
  const { value, onChange, radioGroupClass } = props;
  return $$_ssr(
    $$_templ$a,
    ...$$_custom_element("media-radio-group", { value: value(), $children: () => [renderOptions(props)] }, [{
...
function renderOptions(props) {
  ...
  return options().map((option) => {
    return $$_ssr(
      $$_templ_2$4,
      ...$$_custom_element("media-radio", { value: option.value, $children: () => [option.content()] }, [{
        "part": props.part
      }])
    );
  });
...
const $$_templ$9 = ["<!$><media-thumbnail", "", "</media-thumbnail>"], $$_templ_2$3 = ['<!$><div part="content"><div part="title">', '</div><div part="start-time">', '</div><div part="duration">', "</div></div>"];
class ChaptersMenuItems extends MenuItems {
  ...
  _getOptions() {
    ...
    return track.cues.map((cue, i) => ({
      value: i + "",
      content: () => [
        this._hasThumbnails() && $$_ssr($$_templ$9, ...$$_custom_element("media-thumbnail", { time: cue.startTime }, [{ "part": "thumbnail" }])),
        $$_ssr(
          $$_templ_2$3,
          cue.text,
...
const $$_templ$8 = ['<!$><span part="label"><!$>', "</span>"];
class AudioMenuItems extends MenuItems {
  ...
  _getOptions() {
    ...
    return audioTracks().map((track) => ({
      ...
      content: () => $$_ssr($$_templ$8, track.label)
    }));
  }
  render() {
...
const $$_templ$7 = ['<!$><span slot="label">', "</span>"], $$_templ_2$2 = ['<!$><div slot="hint"></div>'];
...
const $$_templ$6 = ['<!$><span part="label"><!$>', "</span>"], $$_templ_2$1 = $$_templ$6;
class CaptionsMenuItems extends MenuItems {
  ...
  _getOptions() {
    ...
    return [
      { value: "off", content: () => $$_ssr($$_templ$6, offLabel) },
      ...textTracks().filter(isTrackCaptionKind).map((track) => ({
        value: track.label.toLowerCase(),
        content: () => $$_ssr($$_templ_2$1, track.label)
      }))
    ];
  }
  render() {
...
const $$_templ$5 = ['<!$><span part="label"><!$>', "</span>"];
class PlaybackRateMenuItems extends MenuItems {
  ...
  _getOptions() {
    ...
    return rates().map((rate) => ({
      value: rate + "",
      content: () => $$_ssr($$_templ$5, rate === 1 ? normalLabel() : rate + "\xD7")
    }));
  }
  render() {
    const { radioGroupClass } = this.$props;
...
const $$_templ$4 = ["<!$><span><!$>", "</span>"], $$_templ_2 = ['<!$><span part="label">', "</span>"], $$_templ_3 = ['<!$><span part="info">', "</span>"];
class QualityMenuItems extends MenuItems {
  ...
  _getOptions() {
    ...
    return [
      { value: "auto", content: () => $$_ssr($$_templ$4, autoLabel) },
      ...this._sortedQualities().map((quality) => {
        const rate = `${round(quality.bitrate / 1e6, 2)} Mbps`;
        return {
          value: this._getQualityId(quality),
          content: () => [$$_ssr($$_templ_2, quality.height + "p"), !hideBitrate() && $$_ssr($$_templ_3, rate)]
        };
      })
    ];
  }
...
const $$_templ$3 = ['<!$><svg part="icon" fill="none" viewBox="0 0 120 120" aria-hidden="true"><circle part="track" cx="60" cy="60" r="54" stroke="currentColor"></circle><circle part="track-fill" cx="60" cy="60" r="54" stroke="currentColor" pathLength="100"></circle></svg>'];
...
const $$_templ$2 = ['<!$><div part="container"><div part="text">LIVE</div></div>'];
...
class Poster extends Component {
  ...
  render() {
    const { crossorigin } = this._media.$store;
    return $$_ssr($$_templ$1, $$_attr("src", this._imgSrc), $$_attr("alt", this._imgAlt), $$_attr("crossorigin", crossorigin));
  }
}
