...
import { BasePageFrontMatter, Author } from 'vuepress-shared';
...
type ExtendPage<ExtraPageData extends Record<string | number | symbol, unknown> & {
    ...
    git?: GitData;
}, ExtraPageFrontmatter extends PageFrontmatter<BasePageFrontMatter & {
    banner: string;
    cover: string;
}> = PageFrontmatter<BasePageFrontMatter & {
    banner: string;
    cover: string;
}>, ExtraPageFields extends Record<string | number | symbol, unknown> = Record<never, never>> = Page<ExtraPageData, ExtraPageFrontmatter, ExtraPageFields>;
...
export { ArticleJSONLD, ArticleSeoContent, BaseSeoContent, ExtendPage, ExtendedSeoContent, FacebookSeoContent, SeoContent, SeoOptions, SimpleSeoContent, TwitterSeoContent, seoPlugin };
