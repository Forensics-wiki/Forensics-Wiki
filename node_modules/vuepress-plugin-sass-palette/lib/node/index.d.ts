...
declare const sassPalettePlugin: (options: SassPaletteOptions) => PluginFunction;

declare const useSassPalettePlugin: (app: App, options: SassPaletteOptions) => void;
declare const removePalettePlugin: (app: App, id: string) => void;

export { SassPaletteOptions, removePalettePlugin, sassPalettePlugin, useSassPalettePlugin };
