...
import { p as pathBrowserify, l as lib } from './MonacoEditor-d06b3440.js';
import 'vue';
...
async function dispatchGrammars(scopeName) {
  switch (scopeName) {
    case "source.vue":
      return {
        format: "json",
        content: await import('./vue.tmLanguage-1f8c7b61.js')
      };
    case "source.ts":
      return {
        format: "json",
        content: await import('./TypeScript.tmLanguage-01b7ed7f.js')
      };
    case "source.js":
      return {
        format: "json",
        content: await import('./JavaScript.tmLanguage-5b3aef1e.js')
      };
    case "text.html.basic":
      return {
        format: "json",
        content: await import('./html.tmLanguage-98b80916.js')
      };
    case "source.css":
      return {
        format: "json",
        content: await import('./css.tmLanguage-b56789b8.js')
      };
    default:
      return {
        format: "json",
