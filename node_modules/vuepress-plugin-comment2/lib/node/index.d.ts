...
type WalineLocaleConfig = ConvertLocaleConfig<WalineLocaleData>;
interface WalineOptions extends BaseCommentOptions, Omit<WalineInitOptions, "el" | "comment" | "search" | "imageUploader" | "texRenderer"> {
    provider: "Waline";
    /**
 ...
 * Comment options
 */
type CommentOptions = GiscusOptions | TwikooOptions | WalineOptions | DisableCommentOptions;
...
export { CommentOptions, CommentPluginFrontmatter, GiscusInputPosition, GiscusMapping, GiscusOptions, GiscusRepo, GiscusTheme, TwikooInitOptions, TwikooOptions, WalineLocaleConfig, WalineLocaleData, WalineOptions, commentPlugin, walineLocales };
