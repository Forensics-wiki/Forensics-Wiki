...
export default defineComponent({
    ...
    setup() {
        ...
        return () => h("div", { class: "vp-blog-infos" }, [
            h("div", { class: "vp-blog-type-switcher" }, buttons.map(([key, icon]) => h("button", {
                type: "button",
            ...
            active.value === "article"
                ? h("div", { class: "vp-sticky-article-wrapper" }, [
                    ...
                    h("hr"),
                    h("ul", { class: "vp-sticky-articles" }, stars.value.items.map(({ info, path }, index) => h(DropTransition, { appear: true, delay: 0.08 * (index + 1) }, () => h("li", { class: "vp-sticky-article" }, h(VPLink, { to: path }, () => info[ArticleInfoType.title]))))),
                ])
