...
export type HopeThemeSidebarItem = HopeThemeSidebarPageItem | HopeThemeSidebarGroupItem | HopeThemeSidebarStructureItem | string;
export type HopeThemeSidebarArrayConfig = HopeThemeSidebarItem[];
export type HopeThemeSidebarObjectConfig = Record<string, HopeThemeSidebarArrayConfig | "structure" | false>;
export type HopeThemeSidebarConfig = HopeThemeSidebarArrayConfig | HopeThemeSidebarObjectConfig;
...
export type ResolvedSidebarItem = ResolvedHopeThemeSidebarHeaderItem | ResolvedHopeThemeSidebarPageItem | ResolvedHopeThemeSidebarGroupItem;
