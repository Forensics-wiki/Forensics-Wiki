import type { HopeThemeBlogConfig, HopeThemeBlogLocaleData, HopeThemeBlogOptions, HopeThemePaginationLocaleData } from "./blog.js";
import type { HopeThemeEncryptConfig, HopeThemeEncryptLocaleData, HopeThemeEncryptOptions } from "./encrypt.js";
...
export interface HopeThemeFeatureRootConfig extends HopeThemeFeatureLocaleConfig {
    /**
     * Encrypt config
     *
     * 加密配置
