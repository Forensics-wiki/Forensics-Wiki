...
import type { HopeThemeMetaLocateData, HopeThemeMetaLocaleOptions } from "./meta.js";
import type { HopeThemeNavbarLocaleData, HopeThemeNavbarLocaleOptions } from "./navbar.js";
...
export type HopeThemeSidebarInfo = HopeThemeSidebarFileInfo | HopeThemeSidebarDirInfo;
export type HopeThemeSidebarSorterKeyWord = "readme" | "order" | "date" | "date-desc" | "filename" | "file-number" | "file-number-desc" | "title" | "title-number" | "title-number-desc";
export type HopeThemeSidebarSorterFunction = (infoA: HopeThemeSidebarInfo, infoB: HopeThemeSidebarInfo) => number;
export type HopeThemeSidebarSorter = HopeThemeSidebarSorterFunction | HopeThemeSidebarSorterKeyWord | HopeThemeSidebarSorterKeyWord[];
