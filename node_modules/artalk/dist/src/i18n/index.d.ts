 ...
 */
export declare function findLocaleSet(lang: string): I18n;
/**
 * Set system locale
 */
export declare function setLocale(locale: I18n | string): void;
/**
 * Get an i18n message by key
 */
export declare function t(key: I18nKeys, args?: {
    [key: string]: string;
}): string;
export default t;
